...
$sql = "delete from patientschd where id=".$id;
...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `patientschd` WHERE CONCAT(`lname`,`fname`,`mname`,`gender`,`bday`,`age`,`placebday`,`address`,`nationality`,`religion`,`anesthesia`,`surgerytype`,`surgeon`,`anesthesiologist`,`fasting`,`admittime`,`operation`) LIKE '%".$valueToSearch."%'";
...
<form action="admin.php" method="post" enctype="multipart/form-data">
	...
	<div class="card-header" style="width: 100%; margin-left: 0%;">
		...
		<i class="fas fa-edit"></i> PATIENT RECORD/SET SURGERY SCHEDULE
			<a class="btn btn-primary" href="addpatientform.php" style="float:right; margin-left: 0.3%; padding: 5px 10px; margin-top:-0.3%;"><i class="fa fa-user-plus"></i></a></li>
...
<a href="editpatientform.php?id=<?php echo $row['id'] ?>" class="btn btn-success" style=" padding: 5%;"><i class="fa fa-xs fa-user-edit"></i></a>
<a href="admin.php?delete=<?php echo $row['id'] ?>" class="btn btn-danger" style=" padding: 6%;"onclick="return confirm('Are you sure to delete this record?')"><i class="fa fa-xs fa-trash-alt"></i></a>
