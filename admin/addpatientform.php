...
<nav class="navbar navbar-expand-sm bg-info">
 ...
 <a class="navbar-brand" style="color: white;">Patient Add Record</a>
	...
	<div class="card">
		...
		<div class="form-row">
			...
			<div class="form-group col-md-4">
				...
				<div class="input-group mb-2 mr-sm-2">
					<select type="text" class="form-control" name="anesthesia"
						 required>
						<option></option>
						<option>Local</option>
		...
		<div class="form-row">
			<div class="form-group col-md-4">
				...
				<div class="input-group mb-2 mr-sm-2">
					<input type="text" class="form-control"
						id="inlineFormInputGroupUsername2"  name="surgeon"required>
					<div class="input-group-prepend">
						<div class="input-group-text">
							<i class="fas fa-mailbox"></i>
						</div>
			...
			<div class="form-group col-md-4">
				...
				<div class="input-group mb-2 mr-sm-2">
					<input type="text" class="form-control"
						id="inlineFormInputGroupUsername2"  name="anesthesiologist"required>
					<div class="input-group-prepend">
						<div class="input-group-text">
							<i class="fas fa-mailbox"></i>
						</div>
				...
				<div class="input-group mb-2 mr-sm-2">
					<input type="text" id="dob"  name="fasting" class="form-control"
						  required>
					<div class="input-group-prepend">
						<div class="input-group-text">
							<i class="fas fa-mailbox"></i>
		...
		<div class="form-row">
			<div class="form-group col-md-4">
				...
				<div class="input-group mb-2 mr-sm-2">
					<input type="text" name="admittime" class="form-control"
						 required>
					<div class="input-group-prepend">
						<div class="input-group-text">
							<i class="fas fa-mailbox"></i>
			...
			<div class="form-group col-md-4">
				...
				<div class="input-group mb-2 mr-sm-2">
					<input type="text" class="form-control"
						id="inlineFormInputGroupUsername2"  name="operation"
						 required>
					<div class="input-group-prepend">
						<div class="input-group-text">
							<i class="fas fa-mailbox"></i>
