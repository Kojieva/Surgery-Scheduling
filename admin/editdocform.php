...
if(!isset($errorMsg)){
$sql = "update doctorlogin set Username = '".$Username."',Password = '".$Password."' where id=".$id;
$result = mysqli_query($conn, $sql);
if($result){
...
<nav class="navbar navbar-expand-sm bg-info">
 ...
 <a class="navbar-brand" style="color: white;">Admin</a>
  <a class="btn btn-secondary" href="createdoc.php" style="color: white;  margin-right: 0.3%">Back</a>
...
<div class="card-header" style="width: 100%; margin-left: 0%;">
    ...
    <i class="fas fa-edit"></i> EDIT ACCOUNT DOCTOR
