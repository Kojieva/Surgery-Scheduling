...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `adminlogin` WHERE CONCAT(`id`,`Username`) LIKE '%".$valueToSearch."%'";
...
<form action="createadmin.php" method="post" enctype="multipart/form-data">
  ...
  <div class="card-header" style="width: 50%; margin-left: 25%;">
    ...
    <i class="fas fa-edit"></i> ADMIN ACCOUNT RECORD
      <a class="btn btn-primary" href="addadminform.php" style="float:right; margin-left: 0.3%; padding: 5px 10px; margin-top:-0.3%;"><i class="fa fa-user-plus"></i></a></li>
...
<a href="editadminform.php?id=<?php echo $row['id'] ?>" class="btn btn-success" style=" padding: 3%;padding-left: 4%;"><i class="fa fa-xs fa-user-edit"></i></a>
<a href="createadmin.php?delete=<?php echo $row['id'] ?>" class="btn btn-danger" style=" padding: 3%; padding-left: 5%;padding-right: 5%;"onclick="return confirm('Are you sure to delete this record?')"><i class="fa fa-xs fa-trash-alt"></i></a>
